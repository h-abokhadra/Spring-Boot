package ca.sheridancollege.abokhadr.services;
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		ca.sheridancollege.abokhadr.beans.User user = da.findUserAccount(username);
		...
		UserDetails userDetails = (UserDetails) new User(user.getEmail(), user.getEncryptedPassword(),
		grantList);
		return userDetails;
