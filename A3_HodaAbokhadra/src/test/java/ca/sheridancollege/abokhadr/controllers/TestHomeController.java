...
public class TestHomeController {
	...
	/*
	 * @Test public void testLoadingInsertComment() throws Exception {
	 * this.mockMvc.perform(post("/insertComment").flashAttr("comment", new
	 * Comment())).andExpect(status().isOk())
	 * .andExpect(view().name("/secure/view_thread")); }
	 */
}
